...
// Sets focus on next available input field
    ...
    function validateForm(_step){
        ...
        _boxyEmail = document.getElementById('emailP');
        ...
        switch(_step){
            ...
            case 9:
                ...
                if( !_boxyEmail.value ){
                    ...
                    document.getElementById('emailP').placeholder = 'Enter email to reset';
    ...
    $(_boxyRefreshButton).on('click',function(evt){
        ...
        var _emailInput = document.getElementById('emailP');
        ...
        _usernameInput.placeholder = 'Enter email';
        _passwordInput.placeholder = 'Enter password';
        _emailInput.placeholder = 'Enter email to reset';
