/**
 * Created by SOFTAM02 on 11/7/16.
 */
$(function(){
...
// we can fake a successful login…
    ...
    var _boxyLoginForm = document.getElementsByName('boxy-login-form');
...
//var _boxySide = jQuery.makeArray( $(_boxyFormInner).find('span.side') );
    ...
    var _toLogin = _boxyLeftCap.find('.glyphicon-cog'),
...
// Sets focus on next available input field
    ...
    function validateForm(_step){
        ...
        _boxyInput = document.getElementById('email');
        _boxyPassword = document.getElementById('password');
        _boxyEmail = document.getElementById('password_confirmation');
        ...
        switch(_step){
            case 0:
                ...
                if( !_boxyInput.value ){
                    ...
                    $(_boxyRefreshButton).fadeIn('slow');
                    document.getElementById('email').placeholder = 'Ingresar correo electrónico';
            ...
            case 1:
                ...
                if( !_boxyPassword.value ){
                    ...
                    $(_boxyMessage).fadeIn('slow');
                    $(_boxyRefreshButton).fadeIn('slow');
                    document.getElementById('password').placeholder = 'Ingresar contraseña para continuar';
            ...
            case 9:
                ...
                if( !_boxyEmail.value ){
                    ...
                    document.getElementById('password_confrimation').placeholder = 'Confirmar contraseña';
    ...
    $(_boxyRefreshButton).on('click',function(evt){
        ...
        var _usernameInput = document.getElementById('email');
        var _passwordInput = document.getElementById('password');
        var _emailInput = document.getElementById('password_confirmation');
        ...
        _usernameInput.placeholder = 'Ingresar correo eléctronico';
        _passwordInput.placeholder = 'Ingresar contraseña';
        _emailInput.placeholder = 'Confirmar contraseña';
...
$('.glyphicon-cog, .glyphicon-asterisk, .glyphicon-question-sign').on('click',function(evt){
    evt.preventDefault();
